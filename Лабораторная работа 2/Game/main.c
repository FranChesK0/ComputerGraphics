                   ...
                   int nCmdShow)
{
    ...
    while (!bQuit)
    {
        ...
        else
        {
            ...
            TButton_Add(&btn[1], "EXITE", 180, 130, 150, 50, 3);
            TButton_Add(&btn[2], "FIRST", 60, 30, 150, 50, 3);
            TButton_Add(&btn[3], "SECOND", 300, 30, 150, 50, 3);
            btn[1].visible = TRUE;
            btn[2].visible = TRUE;
            btn[3].visible = TRUE;
            glPopMatrix();
        ...
        case WM_LBUTTONDOWN:
            for (int i = 1; i < btnCnt; i++)
                if (PointInButton(LOWORD(lParam), HIWORD(lParam), btn[i]))
                {
                    ...
                    else if (strcmp(btn[i].name, "FIRST") == 0)
                    {
                        printf("FIRST button pushed\n");

                    }
                    else if (strcmp(btn[i].name, "SECOND") == 0)
                    {
